use www;
INSERT INTO `employees` (`employee_id`,`first_name`,`last_name`,`nick_name`,`mobile_phone`,`home_phone`,`availability_notes`) VALUES (NULL,'Patrick','Patterson','Pat','847-555-9706',NULL,'All Saturdays and Sundays in June, July, and August');
